...
public partial class StockDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PurchaseDetailView>(entity =>
        {
            entity.ToView("purchase_detail_view");
            ...
            entity.Property(e => e.SplitPrcoess)
                .HasDefaultValueSql("'NONE'")
                .HasComment("NONE(所有sub_item都尚未經過OWNER拆單),PART(部分sub_item經過OWNER拆單),DONE(所有sub_item經過OWNER拆單)");
            entity.Property(e => e.SubCreatedAt).HasDefaultValueSql("CURRENT_TIMESTAMP");
            entity.Property(e => e.SubOwnerProcess).HasDefaultValueSql("'NONE'");
            entity.Property(e => e.SubReceiveStatus).HasComment("送單到金萬林後，目前狀態\\\\\\\\nNONE : 尚未收到結果\\\\\\\\nPART : 部分驗收入庫\\\\\\\\nDONE : 全部驗收入庫\\\\\\\\nCLOSE:金萬林不同意拆單後的採購項目\\n");
        ...
        modelBuilder.Entity<QcValidationMain>(entity =>
        {
            ...
            entity.Property(e => e.IsReturnStock).HasComment("是否進行退貨:YES、NO");
            ...
            entity.Property(e => e.PreTestResult).HasComment("此產品前一次入庫:PASS符合驗收條件,FAIL未符合驗收條件");
            entity.Property(e => e.ProductModel).HasDefaultValueSql("''");
            entity.Property(e => e.QcType).HasComment("LOT_NUMBER或LOT_NUMBER_BATCH");
            entity.Property(e => e.ReagentManual).HasComment("更換試劑說明書\nYES(勾選是)、NO(勾選否)");
            entity.Property(e => e.SummaryRemarks).HasComment("備註");
            entity.Property(e => e.TeamLeader).HasComment("組長");
            entity.Property(e => e.Tester).HasComment("tester");
            entity.Property(e => e.TestingDate).HasComment("測試時間");
            entity.Property(e => e.UpdatedAt)
                .ValueGeneratedOnAddOrUpdate()
                .HasDefaultValueSql("CURRENT_TIMESTAMP");
