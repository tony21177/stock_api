...
{
    public class ApplyNewProductNotifyJob : IJob
    {
        private readonly EmailService _emailService;

        public ApplyNewProductNotifyJob(EmailService emailService)
        {
        ...
        {
            Dictionary<string,List<EmailNotify>> emailAndNotifyListMap = _emailService.GetApplyNewProductListToSend();
