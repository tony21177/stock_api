...
namespace stock_api.Common.AutoMapper
{
    ...
    .ForMember(dest => dest.OriginalDeadline, opt => opt.MapFrom(src =>
        src.OriginalDeadline != null ? DateTimeHelper.ParseDateString(src.OriginalDeadline) : (DateTime?)null))
            ...
            .ForAllMembers(opt => opt.Condition((src, dest, srcMember) => srcMember != null));
            CreateMap<WarehouseProductStockOutView, WarehouseProductWithInstruments>()
            .ForAllMembers(opt => opt.Condition((src, dest, srcMember) => srcMember != null));
            ...
            .ForAllMembers(opt => opt.Condition((src, dest, srcMember) => srcMember != null));
            CreateMap<InStockItemRecord, InStockItemListWithAbnormal>()
            .ForAllMembers(opt => opt.Condition((src, dest, srcMember) => srcMember != null));
            CreateMap<InStockItemRecord, InStockItemRecordVo>()
            .ForAllMembers(opt => opt.Condition((src, dest, srcMember) => srcMember != null));
            ...
            .ForAllMembers(opt => opt.Condition((src, dest, srcMember) => srcMember != null));
            CreateMap<SupplierTraceLog, SupplierTraceLogVo>()
            .ForAllMembers(opt => opt.Condition((src, dest, srcMember) => srcMember != null));
            ...
            .ForAllMembers(opt => opt.Condition((src, dest, srcMember) => srcMember != null));
            CreateMap<Controllers.Request.AcceptanceDetail, Models.QcAcceptanceDetail>()
            .ForAllMembers(opt => opt.Condition((src, dest, srcMember) => srcMember != null));
