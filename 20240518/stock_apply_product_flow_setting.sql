...
--
-- Dumping data for table `apply_product_flow_setting`
--

LOCK TABLES `apply_product_flow_setting` WRITE;
/*!40000 ALTER TABLE `apply_product_flow_setting` DISABLE KEYS */;
/*!40000 ALTER TABLE `apply_product_flow_setting` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-05-18 14:55:20
